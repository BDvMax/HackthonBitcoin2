...
// 2 of 2 with 1 of 2 recovery using /1/* for recovery keys!
testDesc("wsh(or_d(multi(2,".concat(tpub1, "/0/*,").concat(tpub2, "/0/*),and_v(v:multi(1,").concat(tpub1, "/1/*,").concat(tpub2, "/1/*),older(144))))"));
