...
function DeviceKeyCard({
  ...
  return (
    <div className={cn(
      "relative rounded-none border flex flex-col md:flex-row items-stretch transition-all duration-300 ease-in-out",
      entry.isValid
      ...
      <div className="flex-1 p-6 space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-1.5">
            ...
            <span className="relative group/xpubhelp">
              <HelpCircle className="w-5 h-5 text-zinc-500 group-hover/xpubhelp:text-[#818cf8] transition-colors cursor-help" />
              <span className="pointer-events-none absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-64
                opacity-0 group-hover/xpubhelp:opacity-100 translate-y-1 group-hover/xpubhelp:translate-y-0
                transition-all duration-150 ease-out">
                <span className="block bg-[#0a0c14] border-l-4 border-l-[#6366f1] border-y border-r border-[#1e2640] rounded-sm shadow-xl px-3 py-2.5">
                  <span className="block text-xs font-bold text-[#818cf8] mb-1">¿Dónde encuentro mi XPUB?</span>
                  <span className="block text-xs text-zinc-300 leading-relaxed">{helpText}</span>
                </span>
              </span>
            </span>
          </div>
